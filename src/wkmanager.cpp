...
owkmanager::owkmanager(QWidget *parent, Qt::WindowFlags f) : QWidget(parent, f) {
  ...
  labeluebernahme = new QLabel(tr("Kurve übernehmen", "Wobbelkurvenmanager"), this);
...
void owkmanager::tip(bool btip) {
  QString tip_open = tr(
      ...
      "Kurve im Hintergrund als Grafik einblenden<br> ", "tip_wkmanager");
  ...
  QString tip_wkmcolor = tr(
      ...
      "\"wkm.cfg\" automatisch gespeichert.<br>", "tip_wkmanager");
  QString tip_save = tr(
      "<b>Speicher der Kurve</B><BR>"
      "Hiermit kann die Kurve noch nachträglich gespeichert<br> "
      "werden. Das Format ist gleich dem Format unter dem Menü<br>"
      "\"Kurve\" und kann über das Menü auch wieder eingelesen<br>"
      "werden.<br>", "tip_wkmanager");
...
void owkmanager::save(int nr) {
  ...
  switch (nr) {
    case 1:w = wobbeldaten1;
      break;
    case 2:w = wobbeldaten2;
      break;
    case 3:w = wobbeldaten3;
      break;
    case 4:w = wobbeldaten4;
      break;
    case 5:w = wobbeldaten5;
      break;
    case 6:w = wobbeldaten6;
      break;
...
void owkmanager::suebergabe(const TWobbel &awobbel, const QString &dateiname) {
  ...
  switch (wobbeldaten.kurvennr) {
    case 1:pen1 = wobbeldaten1.penkanal1;
      ...
      saktiv1();
      break;
    case 2:pen1 = wobbeldaten2.penkanal1;
      ...
      saktiv2();
      break;
    case 3:pen1 = wobbeldaten3.penkanal1;
      ...
      saktiv3();
      break;
    case 4:pen1 = wobbeldaten4.penkanal1;
      ...
      saktiv4();
      break;
    case 5:pen1 = wobbeldaten5.penkanal1;
      ...
      saktiv5();
      break;
    case 6:pen1 = wobbeldaten6.penkanal1;
