...
// Info Version usw. 
  ...
  //Schriftgröße des Programmes einstellen
...
void MainWindow::createActions() {
  ...
  mGeraetNeu->setStatusTip(tr("Neuen Gerätepfad anlegen", "Statustip"));
  ...
  mEichenK1->setStatusTip(tr("Kalibrieren Kanal1 (Eigenschaften der Messsonde ermitteln)", "Statustip"));
  connect(mEichenK1, SIGNAL(triggered()), this, SLOT(kalibrierenkanal1()));

  mEichenK2 = new QAction(tr("Kalibrieren Kanal2", "Menu"), this);
  mEichenK2->setStatusTip(tr("Kalibrieren Kanal2 (Eigenschaften der Messsonde ermitteln)", "Statustip"));
  ...
  mSondeLadenK1->setStatusTip(tr("Eigenschaften der Messsonde laden für Kanal 1", "Statustip"));
  ...
  mSondeLadenK2->setStatusTip(tr("Eigenschaften der Messsonde laden für Kanal 2", "Statustip"));
  ...
  mHLine->setStatusTip(tr("Eine zusätzliche dB-Line im Wobbelfenster einblenden", "Statustip"));
  ...
  mBreite = new QAction(QIcon(":/images/breite.png"), tr("Fensterbreite ändern", "Menu"), this);
  mBreite->setStatusTip(tr("Fensterbreite des Hauptfensters verändern", "Statustip"));
  connect(mBreite, SIGNAL(triggered()), this, SLOT(setBreite()));

  mWattFont = new QAction(tr("Schrift einstellen", "Menu"), this);
  mWattFont->setStatusTip(tr("Schriftgröße einstellen", "Statustip"));
  ...
  mDaempfungdefault = new QAction(tr("Dämpfung auf default setzen", "Menu"), this);
  mDaempfungdefault->setStatusTip(tr("Alle zusätzlichen Einträge in der ComboBox löschen", "Statustip"));
...
void MainWindow::setText(QString stty) {
  ...
  setWindowTitle(tr("%1 - V.%2 - %3", "nicht übersetzen").arg(qs).arg(infoversion).arg(stty));
}
...
void MainWindow::msetmenu(emenuenable menuenable, bool einaus) {
  switch (menuenable) {
    case emDrucken:
      mDrucken->setEnabled(einaus);
      break;
    case emDruckenpdf:
      mDruckenpdf->setEnabled(einaus);
      break;
    case emSpeichernpng:
      mSpeichernpng->setEnabled(einaus);
      break;
    case emBeenden:
      mBeenden->setEnabled(einaus);
      break;
    case emEinstellungLaden:
      mEinstellungLaden->setEnabled(einaus);
      break;
    case emEinstellungSichern:
      mEinstellungSichern->setEnabled(einaus);
      break;
    case emInfo:
      mInfo->setEnabled(einaus);
      break;
    case emOption:
      mOption->setEnabled(einaus);
      break;
    case emFirmware:
      mFirmware->setEnabled(einaus);
      break;
    case emKurvenLaden:
      mKurvenLaden->setEnabled(einaus);
      break;
    case emKurvenSichern:
      mKurvenSichern->setEnabled(einaus);
      break;
    case emWobbeln:
      mWobbeln->setEnabled(einaus);
      break;
    case emEinmal:
      mEinmal->setEnabled(einaus);
      break;
    case emStop:
      mStop->setEnabled(einaus);
      break;
    case emEichenK1:
      mEichenK1->setEnabled(einaus);
      break;
    case emEichenK2:
      mEichenK2->setEnabled(einaus);
      break;
    case emSondeLadenK1:
      mSondeLadenK1->setEnabled(einaus);
      break;
    case emSondeLadenK2:
      mSondeLadenK2->setEnabled(einaus);
      break;
    case emSondeSpeichernK1:
      mSondeSpeichernK1->setEnabled(einaus);
      break;
    case emSondeSpeichernK2:
      mSondeSpeichernK2->setEnabled(einaus);
      break;
    case emFontInfo:
      mFontInfo->setEnabled(einaus);
      break;
    case emFrequenzmarke:
      mFrequenzmarke->setEnabled(einaus);
      break;
    case emWattFont:
      mWattFont->setEnabled(einaus);
      break;
    case emWattEichenK1:
      mWattEichenK1->setEnabled(einaus);
      break;
    case emWattEichenK2:
      mWattEichenK2->setEnabled(einaus);
      break;
    case emWattEditSonde1:
      mWattEditSonde1->setEnabled(einaus);
      break;
    case emWattEditSonde2:
      mWattEditSonde2->setEnabled(einaus);
      break;
    case emWattSchreiben:
      mWattSchreiben->setEnabled(einaus);
      break;
    case emTabelleSpeichern:
      mTabelleSpeichern->setEnabled(einaus);
      break;
    case emDaempfungdefault:
      mDaempfungdefault->setEnabled(einaus);
      break;
    case emVersion:
      mVersion->setEnabled(einaus);
      break;
    case emTooltip:
      mTooltip->setEnabled(einaus);
      break;
    case emmenuDatei:
      menuDatei->setEnabled(einaus);
      break;
    case emmenuEinstellung:
      menuEinstellung->setEnabled(einaus);
      break;
    case emmenuKurven:
      menuKurven->setEnabled(einaus);
      break;
    case emmenuwobbel:
      menuwobbel->setEnabled(einaus);
      break;
//    case emmenuvfo: menuvfo->setEnabled(einaus);break;
    case emmenumessen:
      menumessen->setEnabled(einaus);
      break;
    case emmainhidde:
      showMinimized();
      break;
