...
Nwt7linux::Nwt7linux(QWidget *parent) : QTabWidget(parent) {
  ...
  ///////////////////////////////////////////////////////////////////////////////
  //Schnittstelle zum NWT7 erzeugen erzeugen für alle Widgets
  ...
  // Wobbel Widget
  ///////////////////////////////////////////////////////////////////////////////
  // Setzen der Grunddaten für alle Faelle
  ...
  wobdaten.swraufloesung = 4; //Auflösung nur für swr
  ...
  QObject::connect(this, SIGNAL(sendefrqmarken(const TFrqmarken &)), grafik,
                   SLOT(empfangfrqmarken(const TFrqmarken &)));
  ...
  QObject::connect(this, SIGNAL(drucken(const QFont &, const QStringList &)), grafik,
                   SLOT(printdiagramm(const QFont &, const QStringList &)));
  //Signal zum Ausdrucken der Grafik im Widget Grafik als PDF
  QObject::connect(this, SIGNAL(druckenpdf(const QFont &, const QStringList &)), grafik,
                   SLOT(printdiagrammpdf(const QFont &, const QStringList &)));
  //Signal zum Speichern der Grafik im Widget Grafik als PNG
  QObject::connect(this, SIGNAL(bildspeichern(const TBildinfo &, const QStringList &)), grafik,
                   SLOT(bildspeichern(const TBildinfo &, const QStringList &)));
...
//  checkboxtime->setText(tr("Scanzeit größer (Sek)","CheckBox"));
...
//  QObject::connect( checkboxtime, SIGNAL( stateChanged (int)), this, SLOT(checkboxtime_checked(int)));
  ...
  betriebsart->addItem(tr("Spektrumanalysator", "Betriebsart"));
  ...
  edita_100->hide();
  labela_100 = new QLabel(tr("Dämpfung (100m)", "Label"), groupbetriebsart);
  labela_100->hide();
  ...
  labelkabellaenge = new QLabel(tr("Kabellänge (m)", "Label"), groupbetriebsart);
  ...
  labelsabandbreite = new QLabel(tr("Bandweite:", "Label"), groupsa);
  ...
  QObject::connect(boxydbmax, SIGNAL(currentTextChanged(const QString)), this, SLOT(setDisplayYmax(const QString)));
  QObject::connect(boxydbmin, SIGNAL(currentTextChanged(const QString)), this, SLOT(setDisplayYmin(const QString)));
  ...
  groupdaempfung = new QGroupBox(tr("Dämpfung", "GroupBox"), nwt7wobbeln);
  ...
  labelprogressbar = new QLabel(tr("Datenrückfluss", "Label"), groupshift);
  labelnwt = new QLabel("Offline", groupshift);

  mledit = new QTextEdit(nwt7wobbeln);
  //mledit->setReadOnly(true);
  //Signal vom Widget Grafik löschen des Multieditfenster
  ...
  //Verbindung vom Wobbelmanager zum Grafikfenster für die Wobbeldaten
...
//  connect(wkmanager, SIGNAL(warneichkorr()), this, SLOT(warneichkorr()));
  ...
  ///////////////////////////////////////////////////////////////////////////////
  QPalette dp;
  dp.setColor(QPalette::Window, Qt::yellow);
  QPalette dpd;
  dpd.setColor(QPalette::Window, Qt::darkYellow);
  ...
  LCD1->setBackgroundRole(QPalette::Window); //  QPalette::Background
  ...
  LCD2->setBackgroundRole(QPalette::Window);
  //volle schwarze Zahlen
  ...
  LCD3->setBackgroundRole(QPalette::Window);
  //volle schwarze Zahlen
  ...
  LCD4->setBackgroundRole(QPalette::Window);
  //volle schwarze Zahlen
  ...
  LCD5->setBackgroundRole(QPalette::Window);
  //volle schwarze Zahlen
  ...
  checkboxzf->setText(tr("ZF für das Wobbeln aktivieren", "im VFO"));
  checkboxzf->setChecked(false);
  checkboxiqvfo = new QCheckBox(nwt7vfo);
  checkboxiqvfo->setText(tr("VFO-Frequenz x 4 für I/Q Mischer", "im VFO"));
  ...
  labeldaempfung1 = new QLabel(tr("Dämpfungsglied", "im VFO"), nwt7vfo);
  ...
  labelldaempfungk1 = new QLabel(tr("Dämpfung (dB)", "im Wattmeter"), nwt7messen);

  ldaempfungk2 = new QComboBox(nwt7messen);
  ldaempfungk2->setEditable(true);
  labelldaempfungk2 = new QLabel(tr("Dämpfung (dB)", "im Wattmeter"), nwt7messen);
  ...
  buttonmess = new QPushButton(tr("Übernahme", "im Wattmeter"), nwt7messen);
...
//  labelspghz->hide();
  ...
  labeldaempfung3 = new QLabel(tr("Dämpfung", "im Wattmeter"), nwt7messen);
  daempfung3->hide();
  ...
  groupschwingkreisc = new QGroupBox(tr("Schwingkreisberechnung Kapazität", "in Berechnungen"), berechnung);
  ...
  labell2 = new QLabel(tr("uH Induktivität", "in Berechnungen"), groupschwingkreisc);
  labelf2 = new QLabel(tr("MHz Frequenz", "in Berechnungen"), groupschwingkreisc);
  labelc2 = new QLabel(tr("pF Kapazität", "in Berechnungen"), groupschwingkreisc);
  ...
  labell1 = new QLabel(tr("uH Induktivität", "in Berechnungen"), groupschwingkreisl);
  labelc1 = new QLabel(tr("pF Kapazität", "in Berechnungen"), groupschwingkreisl);
  ...
  labeleditl3 = new QLabel(tr("uH Induktivität", "in Berechnungen"), groupwindungen);
  ...
  lbeschrdaempfung = new QLabel(tr("(dB) Einfügedämpfung", "in Impedanz"), gzr);
  ...
  bsim = new QPushButton(tr("Simulation"), gdiagramm);
  ...
  spingradbegin->setMinimum(0);
  spingradbegin->setMaximum(180);
  spingradbegin->setSingleStep(1);

  spingradbegin->setValue(0);
  spingradend = new QSpinBox(gdiagrammdim);
  spingradend->setMinimum(180);
  spingradend->setMaximum(360);
  spingradend->setSingleStep(1);
  ...
  //für die Lupenfunktion
  bdauerwobbeln = false;
  //für das Wattmeter zur Spitzenanzeige
  counterspitzek1 = 0;
  counterspitzek2 = 0;
  ...
  setTabEnabled(indexOf(nwt7vfo), false);
  setTabEnabled(indexOf(nwt7messen), false);
  setTabEnabled(indexOf(berechnung), true);
  ...
  //Idletimer ist für die Kontaktaufnahme mit dem NWT
...
void Nwt7linux::editsonde1() {
  ...
  if (r == QDialog::Accepted) {
    sonde = dlg->getdaten();
    boxwattoffset1->clear(); // Box löschen
    for (int i = 0; i < 30; i++) {
      snum = QString::asprintf("%2i| ", i + 1);
...
void Nwt7linux::setDaempfungItem() {
  ...
  if (wgrunddaten.bdaempfungfa) {
    ...
    labeldaempfung1->setText(tr("Dämpfung 0dB/66dB", "Tab VFO"));
    labeldaempfung3->setText(tr("Dämpfung 0dB/66dB", "Tab Wattmeter"));
    ...
    labeldaempfung1->setText(tr("Dämpfung 0dB/50dB", "Tab VFO"));
    labeldaempfung3->setText(tr("Dämpfung 0dB/50dB", "Tab Wattmeter"));
    daempfung1->addItem("0dB");
    daempfung1->addItem("10dB");
    daempfung1->addItem("20dB");
    daempfung1->addItem("30dB");
...
void Nwt7linux::menuanfangsetzen() {
  ...
  if (wobdaten.einkanalig) {
    ...
    labelldaempfungk2->setText(tr("Dämpfung (dB)", "im Wattmeter"));
...
void Nwt7linux::configurationladen(const QString &filename) {
...
#ifdef Q_OS_WIN
  wgrunddaten.str_tty = nwt7configfile.readString("serielle_schnittstelle", "COM4");
#else
  wgrunddaten.str_tty = nwt7configfile.readString("serielle_schnittstelle", "/dev/ttyUSB0");
#endif
  ...
  //ab FW 1.20 neue Parameter für das NF Wobbeln
  ...
  /////////////////////////////////////////////////
  //Paramatemeter für das Antennendiagram
  /////////////////////////////////////////////////
  ...
  /////////////////////////////////////////////////
  //Paramatemeter für das Einblenden der Infotexte
  /////////////////////////////////////////////////
  ...
  // }
  for (i = 1; i < p; i++) {
    qs = QString::asprintf("profilname%02i", i);
    qs = nwt7configfile.readString(qs, "def");
    if (qs != "NN") {
      qs = QString::asprintf("profilname%02i", i);
      aprofil[j].name = nwt7configfile.readString(qs, "0");
      qs = QString::asprintf("profilanfang%02i", i);
      aprofil[j].anfang = nwt7configfile.readString(qs, "0");
      qs = QString::asprintf("profilende%02i", i);
      aprofil[j].ende = nwt7configfile.readString(qs, "0");
      qs = QString::asprintf("profilschritte%02i", i);
      aprofil[j].schritte = nwt7configfile.readString(qs, "1");
      boxprofil->addItem(aprofil[j].name);
      j++;
    }
  ...
  LCD1->display(qs = QString::asprintf("%2.6f", lcdfrq1 / 1000000.0));
  LCD2->display(qs = QString::asprintf("%2.6f", lcdfrq2 / 1000000.0));
  LCD3->display(qs = QString::asprintf("%2.6f", lcdfrq3 / 1000000.0));
  LCD4->display(qs = QString::asprintf("%2.6f", lcdfrq4 / 1000000.0));
  LCD5->display(qs = QString::asprintf("%2.6f", lcdfrq5 / 1000000.0));
  ...
  wobdaten.bswrrelais = nwt7configfile.readBool("SWR_Relais", false); //Relais für NWT500 Nachbau
  ...
  wobdaten.frqfaktor = nwt7configfile.readInteger("frequenzfaktor", 10);
  setFrqFaktorLabel();
    ...
    if (!sw305) {
      QMessageBox::warning(this, tr("Messondendateien alte Version", "Konfiguration laden"),
                           tr("<B>Die Kalbrierdaten einer Messondendatei sind im alten Format! </B><BR>"
                              ...
                              "möglich. Das neue Format wurde notwendig mit der Einfuehrung <br>"
                              "der Skalierung der Y-Achse. <br>"
                              "<b>Es ist eine neue Kalibrierung durchzufuehren! </b><br>"
                              "Das neue Format wird ab Version 3.05 verwendet. <br>", "Konfiguration laden"));
    }
  }
}
...
void Nwt7linux::configurationspeichern(const QString &filename) {
  ...
  nwt7configfile->open(filename);
  qs = QString::asprintf("%01i.%02i:V%02i", fwversion / 100, fwversion - 100, fwvariante);
  ...
  for (i = 5; i < ldaempfungk1->count(); i++) {
    qs = QString::asprintf("powerk1%i", i);
  ...
  for (i = 5; i < ldaempfungk2->count(); i++) {
    qs = QString::asprintf("powerk2%i", i);
...
void Nwt7linux::beenden() {
  ...
  wkmanager->beenden();
  if (bttyOpen) {
    defaultlesenrtty(); //eventuelle Daten im UART löschen
    picmodem->closetty();
  }
  qApp->exit(0);
}
...
void Nwt7linux::EinstellungLaden() {
  QString s = QFileDialog::getOpenFileName(
      this,
      tr("NWT Konfiguration laden"),
      homedir.filePath("*.hfc"),
      tr("NWT Konfigurationsdatei (*.hfc)"));
...
void Nwt7linux::EinstellungSichern() {
  QString s = QFileDialog::getOpenFileName(
      this,
      tr("NWT Konfiguration speichern"),
      homedir.filePath("*.hfc"),
      tr("NWT Konfigurationsdatei (*.hfc)"));
...
void Nwt7linux::getwkm(int i) {
  switch (i) {
    case 1:wobdaten.kurvennr = 1;
      break;
    case 2:wobdaten.kurvennr = 2;
      break;
    case 3:wobdaten.kurvennr = 3;
      break;
    case 4:wobdaten.kurvennr = 4;
      break;
    case 5:wobdaten.kurvennr = 5;
      break;
    case 6:wobdaten.kurvennr = 6;
      break;
...
*/
      ...
      switch (i) {
        case 0: //wobbeln dB
          ...
          setTabEnabled(indexOf(nwt7messen), true);
          break;
        case 1: // wobbeln SWR
        ...
        case 5: // wobbeln SAV
          ...
          if (ikversion > 305) {
            // Version > 3.05
            //noch zusaetliche Daten für die dBm Darstellung einlesen
            ts >> wobdaten.psavabs;
            ts >> wobdaten.psav300;
            ts >> wobdaten.psav7k;
            ts >> wobdaten.psav30k;
...
//  warneichkorr();
  ...
  ekv = loadkurve();
  switch (ekv) {
    case ekvabbruch:return;
      break;
    case ekvkeine:v305 = false;
      v404 = false;
      v405 = false;
      v410 = false;
      break;
    case ekv305:v305 = true;
      v404 = false;
      v405 = false;
      v410 = false;
      s = " #V3.05";
      break;
    case ekv404:v305 = true;
      v404 = true;
      v405 = false;
      v410 = false;
      s = " #V4.04";
      break;
    case ekv405:v305 = true;
      v404 = true;
      v405 = true;
      v410 = false;
      s = " #V4.05";
      break;
    case ekv410:v305 = true;
      v404 = true;
      v405 = true;
      v410 = true;
      s = " #V4.10";
...
void Nwt7linux::KurvenSichern() {
  ...
  if (!s.isNull()) {
    ...
    qs = kurvendir.absolutePath();
    //qDebug(qs);
    //Datei ueberpruefen ob Suffix vorhanden
    ...
    if (f.open(QFile::WriteOnly)) {
      ...
      ts << wobdaten.anfangsfrequenz << Qt::endl;
      ts << wobdaten.schrittfrequenz << Qt::endl;
      //qDebug() << "Neu 2: " << wobdaten.schritte;
      ts << wobdaten.schritte << Qt::endl;
      ts << wobdaten.faktor1 << Qt::endl;
      ts << wobdaten.shift1 << Qt::endl;
      ts << wobdaten.faktor2 << Qt::endl;
      ts << wobdaten.shift2 << Qt::endl;
      switch (wobdaten.ebetriebsart) {
        ...
        case espekdisplayshift:
          //speky == 5
          ts << 5 << Qt::endl;
          ts << wobdaten.psavabs << Qt::endl;
          ts << wobdaten.psav300 << Qt::endl;
          ts << wobdaten.psav7k << Qt::endl;
          ts << wobdaten.psav30k << Qt::endl;
          switch (wobdaten.ebbsav) {
            case ekeinebandbreite:ts << 0 << Qt::endl;
              break;
            case e300b1:ts << 1 << Qt::endl;
              break;
            case e7kb1:ts << 2 << Qt::endl;
              break;
            case e30kb1:ts << 3 << Qt::endl;
              break;
            case e300b2:ts << 4 << Qt::endl;
              break;
            case e7kb2:ts << 5 << Qt::endl;
              break;
            case e30kb2:ts << 6 << Qt::endl;
              break;
          }
          ts << wobdaten.displayshift << Qt::endl;
          break;
        case eantdiagramm:break;
      }
      //Messung speichern
      for (i = 0; i < wobdaten.schritte; i++) {
        ts << wobdaten.mess.k1[i] << Qt::endl;
      }
      for (i = 0; i < wobdaten.schritte; i++) {
        ts << wobdaten.mess.k2[i] << Qt::endl;
      }
      ...
      for (i = 0; i < maxmesspunkte; i++) {
        ts << wobdaten.kalibrierarray.arrayk1[i] << Qt::endl;
      }
      for (i = 0; i < maxmesspunkte; i++) {
        ts << wobdaten.kalibrierarray.arrayk2[i] << Qt::endl;
      }
      for (i = 0; i < maxmesspunkte; i++) {
        ts << wobdaten.swrkalibrierarray.arrayk1[i] << Qt::endl;
      }
      for (i = 0; i < maxmesspunkte; i++) {
        ts << wobdaten.swrkalibrierarray.arrayk2[i] << Qt::endl;
      }
      for (i = 0; i < calmaxindex; i++) {
        ts << wobdaten.savcalarray.p[i] << Qt::endl;
      }
      f.close();
    }
    QString finfo = s;
    ...
    if (wobdaten.ebetriebsart == ewobbeln) {
      if (QMessageBox::question(this, tr("CSV-Datei erzeugen"),
                                tr("<B>Es wird zusätzlich eine CSV-Datei mit gleichem Name erzeugt.</B><BR>"
                                   "Datei speichern?"),
        ...
        if (f.open(QFile::WriteOnly)) {
          ...
          for (i = 0; i < wobdaten.schritte; i++) {
            ...
            if (wobdaten.linear1 or wobdaten.linear2) {
              ...
              f2 = (100.0 + f2) / 100.0;
              db2 = 20.0 * log10(f2);
              qs = QString::asprintf("%9.0f", frq);
              if (wobdaten.bkanal1) {
                qs1 = QString::asprintf(";%1.5f;%2.5f", f1, db1);
                qs = qs + qs1;
              }
              if (wobdaten.bkanal2) {
                qs1 = QString::asprintf(";%1.5f;%2.5f", f2, db2);
                qs = qs + qs1;
              }
            } else {
              ...
              qs = QString::asprintf("%9.0f", frq);
              if (wobdaten.bkanal1) {
                qs1 = QString::asprintf(";%2.5f", db1);
                qs = qs + qs1;
              }
              if (wobdaten.bkanal2) {
                qs1 = QString::asprintf(";%2.5f", db2);
                qs = qs + qs1;
              }
            }
            qs.replace('.', ',');
...
void Nwt7linux::messsondenfilek1laden(const QString &filename) {
  ...
  if (!s.isNull()) {
    ...
    //Filename setzen für SWV Eichdatei lesen
    f.setFileName(homedir.filePath(s));
    if (f.open(QFile::ReadOnly)) {
      QTextStream ts(&f);
      for (i = 0; i < maxmesspunkte; i++) {
...
void Nwt7linux::messsondespeichern1(const QString &sa) {
  ...
  if (!bersterstart) {
    beschr = tr("<b>Name der Messsonde am Checkbutton</b><br>"
                ...
                "den vorgegebenen Name übernehmen:", "FileDialog");
  }
...
void Nwt7linux::messsondespeichern2(const QString &sa) {
  ...
  if (!bersterstart) {
    beschr = tr("<b>Name der Messsonde am Checkbutton</b><br>"
                "Gib der Messonde einen Name oder<br>"
                "den vorgegebenen Name übernehmen:", "InputDialog");
  }
  if (s1 == "def") {
...
void Nwt7linux::kalibrierenkanal1() {
  ...
  if (!bttyOpen) {
    ...
    if (!bttyOpen) {
      QMessageBox::warning(this, tr("Serielle Schnittstelle"),
                           "\"" + wgrunddaten.str_tty + tr("\" Lässt sich nicht öffnen!"));
#ifdef LDEBUG
  ...
  switch (wobdaten.ebetriebsart) {
    case eantdiagramm:break;
    case espekdisplayshift:break;
    case espektrumanalyser:break;
    case ewobbeln: {
      QMessageBox msgBox;
      msgBox.setWindowTitle(tr("Art der Messsonde"));
      msgBox.setText(tr("<B>Die Messonde bitte auswählen</B><BR>Ist die Messsonde linear oder logarithmisch?"));
      msgBox.setStandardButtons(QMessageBox::StandardButton::Yes | QMessageBox::StandardButton::No);
      msgBox.button(QMessageBox::StandardButton::Yes)->setText(tr("L&in."));
      msgBox.button(QMessageBox::StandardButton::No)->setText(tr("L&og."));
      ...
      if (!wobdaten.linear1) {
        ...
        QMessageBox::warning(this, tr("Kalibrieren Kanal 1", "InformationsBox"),
                             tr("<B>Ermittlung der -40dB Linie</B><BR>"
                                ...
                                "Dämpfungsglied vorhanden ist.</em>", "InformationsBox"));
      } else {
        if (wgrunddaten.bdaempfungfa) {
          setDaempfung(2); // -6dB
        ...
        QMessageBox::warning(this, tr("Kalibrieren Kanal 1", "InformationsBox"),
                             tr("<B>Ermittlung der 0,5 Linie</B><BR>"
                                ...
                                "<em>Bitte nur wenn kein automatisches <BR>"
                                "Dämpfungsglied vorhanden ist, was diese <br>"
                                "Auflösung beherrscht.</em>", "InformationsBox"));
      }
      break;
      //SWR kalibrieren
    }
    case eswrneu:s = QString::asprintf("%li", wgrunddaten.kalibrierstep);
...
void Nwt7linux::kalibrierenkanal2() {
  ...
  switch (wobdaten.ebetriebsart) {
    ...
    case ewobbeln: {
      ...
      if (fwversion == 120) {
        if (QMessageBox::question(this, tr("Messkopf Kanal 2"),
                                  tr("<B>Art des Messkopfes</B><BR>"
                                     "Ist das ein Audio-NF Messkopf?"),
                                  QMessageBox::Yes, QMessageBox::No) == QMessageBox::Yes) {
...
void Nwt7linux::idletimerbehandlung() {
  //Kalibrierwerte für die Erkennung der eingestellten Werte am SAV
  int sa75_003 = 353;
  int sa75_05 = 446;
  int sa75_30 = 544;
  int sa148_003 = 674;
  ...
  setparkfrq();
  //Vorbereitung für Farbeinstellung
  ...
  if (fwversion != 0) {
    ...
    fwversioncounter = 3;
    setTabEnabled(indexOf(nwt7vfo), true);
    ...
    if ((fwversion > 114) and (fwversion < 150)) {
      ...
      if (!vabfrage) {
        ...
        if (fwsav < 10) {
          labelsafrqbereich->setText(tr("kein Spektrumanalysator", "Label"));
        ...
        if ((fwsav >= 10) and (fwsav < sa75_003)) {
          ...
          labelsabandbreite->setText(tr("Bandweite: 30 kHz", "Label"));
        ...
        if ((fwsav >= sa75_003) and (fwsav < sa75_05)) {
          labelsafrqbereich->setText(tr("Scanbereich 1", "Label"));
          labelsabandbreite->setText(tr("Bandweite: 7 kHz", "Label"));
          if (wgrunddaten.sastatus) {
            sabereich1->setChecked(true);
            sabereich2->setChecked(false);
            sabereich = bsa1;
        ...
        if ((fwsav >= sa75_05) and (fwsav < sa75_30)) {
          labelsafrqbereich->setText(tr("Scanbereich 1", "Label"));
          labelsabandbreite->setText(tr("Bandweite: 300 Hz", "Label"));
          if (wgrunddaten.sastatus) {
            sabereich1->setChecked(true);
            sabereich2->setChecked(false);
            sabereich = bsa1;
      ...
      if ((wobdaten.ebetriebsart == espektrumanalyser/* or wobdaten.ebetriebsart == espekdisplayshift*/) and
          wgrunddaten.sastatus) {
        //nur Frequenz umspeichern wenn HW Rückmeldung und Betriebsart SA
        setFrqBereich();
      }
    }
  } else {
...
void Nwt7linux::clickwobbeln() {
  ...
  if (!bttyOpen) {
    ...
    if (!bttyOpen) {
      QMessageBox::warning(this, tr("Serielle Schnittstelle", "WarungsBox"),
                           "\"" + wgrunddaten.str_tty + tr("\" Lässt sich nicht öffnen!", "WarungsBox"));
#ifdef LDEBUG
  ...
  if (bkurvegeladen) {
    ...
    switch (wobdaten.ebetriebsart) {
      case eantdiagramm:break;
      case ewobbeln:betriebsart->setCurrentIndex(0);
        break;
      case eswrneu:betriebsart->setCurrentIndex(1);
        break;
      case eswrant:betriebsart->setCurrentIndex(2);
        break;
      case eimpedanz:betriebsart->setCurrentIndex(3);
        break;
      case espektrumanalyser:betriebsart->setCurrentIndex(4);
        break;
      case espekdisplayshift:betriebsart->setCurrentIndex(5);
        break;
    }
...
//    daempfung2->setEnabled(false);
    ...
    wobbelstop = false;
    setTabEnabled(indexOf(wkmanager), false);
    setTabEnabled(indexOf(nwt7vfo), false);
    setTabEnabled(indexOf(berechnung), false);
    setTabEnabled(indexOf(nwt7messen), false);
    sendwobbeln();
    wobdaten.mousesperre = true; //Kursoraktivitaeten sperren
    fsendewobbeldaten();
  }
  //Zaehler für Abbruch des Datenverkehrs
  abbruchlevel = 0;
...
*/
  ...
  //NF Wobbeln
  if ((checkboxk2->isChecked()) and (checkboxk1->isChecked()) and
      (wobdaten.maudio2) and (fwversion == 120)) {
    ...
    //qDebug() << "ztime :"  << ztime;
    qs = QString::asprintf("%09li%08li%04i%03i%02i", fanfang, fschrittfrequenz, wobdaten.schritte, ztime,
                           wgrunddaten.audiosens);
    if (wobdaten.linear1 or wobdaten.linear2) {
    ...
    if (boxzwischenzeit->currentIndex() != 0) {
      qs = QString::asprintf("%09li%08li%04i%03i",
                             fanfang,
                             fschrittfrequenz,
                             wobdaten.schritte,
                             wobdaten.ztime);
      ...
      qs = QString::asprintf("%09li%08li%04i", fanfang,
                             fschrittfrequenz,
                             wobdaten.schritte);
      if (wobdaten.linear1 or wobdaten.linear2) {
  ...
  if (bttyOpen) {
    defaultlesenrtty(); //eventuelle Daten im UART löschen
    //zuerst 8fh senden Vektor für LinuxSW im PIC
    picmodem->writeChar(143);
    picmodem->writeLine(qs.toStdString().c_str());
    //qDebug() << "sendwobbeln()";
    //qDebug() << qs;
    wcounter = 3;
    idletimer->stop();
...
void Nwt7linux::readtty() {
  ...
  if (((wobdaten.schritte) * bufferfaktor) == ttyindex) {
    ...
    if (wobbelstop) {
      ...
      setTabEnabled(indexOf(wkmanager), true);
      setTabEnabled(indexOf(nwt7vfo), true);
      setTabEnabled(indexOf(berechnung), true);
      ...
      if (bkalibrieren0) {
          ...
          if (bkalibrierenswr) {
            ...
            if (!wobdaten.linear1) {
              ...
              for (i = 0; i < wobdaten.schritte; i++) {
                ...
                findex = (afrequenz + (wobdaten.schrittfrequenz * i)) / wobdaten.frqfaktor;
                j = int(findex / eteiler);
                wobdaten.kalibrierarray.arrayk1[j] =
                    (double(wobdaten.mess.k1[i]) * wobdaten.faktor1 + wobdaten.shift1) -
                        maxkalibrier;
          ...
          if (bkalibrierenswr) {
            ...
            if (!wobdaten.linear2) {
              ...
              for (i = 0; i < wobdaten.schritte; i++) {
                ...
                findex = (afrequenz + (wobdaten.schrittfrequenz * i)) / wobdaten.frqfaktor;
                j = int(findex / eteiler);
                wobdaten.kalibrierarray.arrayk2[j] =
                    (double(wobdaten.mess.k2[i]) * wobdaten.faktor2 + wobdaten.shift2) -
                        maxkalibrier;
                //qDebug(" nkalibrierarray.arrayk1[j] %f", nkalibrierarray.arrayk1[j]);
                //yf = double(wobdaten.mess.k1[i]) * wobdaten.faktor1 + wobdaten.shift1;
                //nkalibrierarray.arrayk1[j] = (yaufloesung * (0.9 - maxkalibrier/10.0)) - yf;
        ...
        if (QMessageBox::question(this,
                                  tr("Kalibrierung speichern? -- NWT", "WarnungsBox"),
      ...
      if (bkalibrieren40) {
        ...
        if (checkboxk1->isChecked()) {
          ...
          if (!wobdaten.linear1) {
            QString beschr(tr("<B>Ermitteln der zweiten dB Linie Kanal1</B><BR>"
                              ...
                              "kleines Dämpfungsglied einschleifen."
                              "<BR><BR>"
        ...
        //erneut wobbeln
        sendwobbeln();
        //Timer starten für lesen der NWT7 Daten
        idletimer->stop();
        stimer->stop();
        vtimer->stop();
...
void Nwt7linux::setFrqBereich() {
  ...
  //nur wenn sich Beriebsart oder SA-Bereich ändert
  ...
  if (wobdaten.bswrrelais) {
    if (!bttyOpen) {
      ...
      if (!bttyOpen) {
        QMessageBox::warning(this, tr("Serielle Schnittstelle", "InformationsBox"),
                             "\"" + wgrunddaten.str_tty +
                                 tr("\" Lässt sich nicht öffnen!", "InformationsBox"));
#ifdef LDEBUG
...
void Nwt7linux::readberechnung(double a) {
  QString s;
  s = QString::asprintf("%f", a / 1000000.0);
  editf1->setText(s);
  editf2->setText(s);
}
...
double Nwt7linux::linenormalisieren(const QString &line) {
  ...
  if (ergebnis >= 10000000000.0)ergebnis = 0.0; // größer als 9,999.. GHz verhindern
  return ergebnis;
}
...
void Nwt7linux::wobnormalisieren() {
  ...
  bw = 0.0,  //Spektrumanalysator Bandbreitenkontrolle
  frqfaktor, //Faktor für Frequenzvervielfachung
  neueschrittweite,
      neueschritte,
  ...
  //Anzahl der Schritte ändern wenn Frequenzabstand zu klein
  if (schrittweite == 1) {
  ...
  sdisplayshift = QString::asprintf("%1.0f", displayshift);
  ...
  sdbshift2 = boxdbshift2->currentText();
  /////////////////////////////////////////////////////////////////////////////
  //Alle wichtigen werte sind gefüllt ?
  /////////////////////////////////////////////////////////////////////////////
  if ((sanfang.length() > 0) & (sende.length() > 0) & (sschritte.length() > 0)) {
    ...
    if (schritte < 2.0) {
      schritte = 2.0;
      sschritte = QString::asprintf("%1.0f", schritte);
    ...
    ///////////////////////////////////////////////////////////////////////////
    if (anfang >= ende) {
      ende = anfang + 1.0; //min um 1  erhöhen
    }
    ///////////////////////////////////////////////////////////////////////////
    ...
    ///////////////////////////////////////////////////////////////////////////
    if (sabw != bwkein and
        ((wobdaten.ebetriebsart == espektrumanalyser) or (wobdaten.ebetriebsart == espekdisplayshift))) {
      saschrittkorr = false; //Schrittanzahl für den SA nicht OK
      sakorrnachoben = false; //keine Schrittweite nach oben korrigieren
      // Test ob Schrittweite erhöht werden muss
      if (sabw == bw30kHz and schrittweite > wgrunddaten.bw30kHz_max) {
        saschrittkorr = true;
        bw = wgrunddaten.bw30kHz_max;
      }
      ...
      if (saschrittkorr) {
        if (bw < 1000.0) {
          sbw = QString::asprintf(" %1.0fHz !!!", bw);
        } else {
          sbw = QString::asprintf(" %1.2fkHz !!!", bw / 1000.0);
        }
        ...
        if ((schritteneu < wgrunddaten.saminschritte) and wgrunddaten.bschrittkorr)
          schritteneu = wgrunddaten.saminschritte;
        ...
        sschrittweite = QString::asprintf("%1.0f", schrittweite);
        ...
        if ((schritteneu == schrittmax) and wgrunddaten.bwarnsavbwmax and !sakorrnachoben) {
          ...
          button = QMessageBox::warning(this, tr("SAV-Bandbreitenueberpruefung",
                                                 "InformationsBox Bandbreitenueberpruefung max"),
                                        tr("Die Schrittweite ist höher als",
                                           "InformationsBox Bandbreitenueberpruefung max")
                                            + sbw + "<br><br> " +
                                            tr("Die maximale Schrittanzahl ist erreicht und voreingestellt.<br>"
                                               "<b>Bitte die Scanweite verringern oder die Bandbreite erhöhen!</b>",
                                               "InformationsBox Bandbreitenueberpruefung max"),
          ...
          if (wgrunddaten.bschrittkorr) {
            ...
            if (wgrunddaten.bwarnsavbw and !sakorrnachoben) {
              ...
              button = QMessageBox::question(this, tr("SAV-Bandbreitenueberpruefung",
                                                      "InformationsBox Bandbreitenueberpruefung"),
                                             tr("Die Schrittweite ist höher als",
                                                "InformationsBox Bandbreitenueberpruefung")
                                                 + sbw + "<br><br> " +
                                                 tr("Die neuen Werte sind schon eingetragen. <br>"
                                                    "Sollen die Werten uebernommen werden?",
                                                    "InformationsBox Bandbreitenueberpruefung"),
    ...
    switch (wobdaten.ebetriebsart) {
      ...
      case eimpedanz:
      case espektrumanalyser:
      case espekdisplayshift:schrittweite = qRound((ende - anfang) / (schritte - 1.0));
        break;
    }
    //sind die Schritte kleiner als 1.0
    if (schrittweite < 1.0) {
    ...
    switch (wobdaten.ebetriebsart) {
      ...
      case eswrneu:
      case eswrant:
      case eimpedanz:wgrunddaten.wanfang = anfang;
...
void Nwt7linux::setmessen() {
  ...
  if (fwversion == 120) {
    messtime = messtimeneu; //ab FW 1.20 die Zwischenzeit für
  ...
  if (!bttyOpen) {
    ...
    if (!bttyOpen) {
      QMessageBox::warning(this, tr("Wattmeter", "InformationsBox"),
                           "\"" + wgrunddaten.str_tty + tr("\" Lässt sich nicht öffnen!", "InformationsBox"));
#ifdef LDEBUG
    ...
    if (bttyOpen) {
      ...
      if (a < 4) {
        ...
        if (messcounter == maxcount) {
          ...
          if (anzeigeneu) {
            //Kanal 1
            qs = QString::asprintf("%i", int(messungk1 / maxcount));
            mlabelk1->setText(qs);
            if (fwversion == 120) {
          ...
          w = w + woffset1;
          qs = QString::asprintf("%2.1f dBm", w);
          if (wgrunddaten.wmprezision == 2) qs = QString::asprintf("%2.2f dBm", w);
          qsline = qs;
          ...
          if (uv > 999) {
            qs = QString::asprintf("%3.3f kV", uv / 1000);
          }
          if (uv < 1000) {
            qs = QString::asprintf("%3.1f V", uv);
          }
          if (uv < 1.0) {
            uv = uv * 1000.0;
            qs = QString::asprintf("%3.1f mV", uv);
          }
          if (uv < 1.0) {
            uv = uv * 1000.0;
            qs = QString::asprintf("%3.1f uV", uv);
          }
          if (anzeigeneu)messlabel3->setText(qs);
          qsline = qsline + "; " + qs;
          if (p > 999) {
            qs = QString::asprintf("%3.3f kW", p / 1000);
          }
          if (p < 1000) {
            qs = QString::asprintf("%3.1f W", p);
          }
          if (p < 1.0) {
            p = p * 1000.0;
            qs = QString::asprintf("%3.1f mW", p);
          }
          if (p < 1.0) {
            p = p * 1000.0;
            qs = QString::asprintf("%3.1f uW", p);
          }
          if (p < 1.0) {
            p = p * 1000.0;
            qs = QString::asprintf("%3.1f nW", p);
          }
          if (p < 1.0) {
            p = p * 1000.0;
            qs = QString::asprintf("%3.1f pW", p);
          }
          ...
          if (!wobdaten.einkanalig) {
            ...
            if (anzeigeneu) {
              qs = QString::asprintf("%i", int(messungk2 / maxcount));
              mlabelk2->setText(qs);
              if (fwversion == 120) {
            ...
            w = w + woffset2;
            if (wobdaten.maudio2) {
              qs = QString::asprintf("%2.2f dBV", w);
            } else {
              qs = QString::asprintf("%2.1f dBm", w);
              if (wgrunddaten.wmprezision == 2)qs = QString::asprintf("%2.2f dBm", w);
            }
            ...
            if (uv < 1.0) {
              uv = uv * 1000.0;
              qs = QString::asprintf("%3.2f mV", uv);
            }
            if (uv < 1.0) {
              uv = uv * 1000.0;
              qs = QString::asprintf("%3.2f uV", uv);
            }
          ...
          if (bmkalibrierenk1_20db) {
            ...
            if (QMessageBox::question(
              ...
              QMessageBox::warning(this, tr("Speicher der Ergebnisse", "InformationsBox"),
                                   tr("<B>Speichern der Werte in der Messsondendatei</B><BR>"
                                      "Die ermittelten Daten können unter<BR>"
          ...
          if (bmkalibrierenk1_0db) {
            ...
            QString beschr(tr("<b>Kalibrieren Kanal 1</b><br>"
                              "1. Den Pegel mit einem Dämpfungsglied verringern.<br>"
                              "   Das Dämpfungsglied sollte min. 20dB betragen.<br>"
                              "   <br><br>"
                              "Werte des Dämpfungsgliedes (dB):", "InformationsBox"));
...
//                                                  QString::null, 0, 1) == 0) {
          ...
          if (bmkalibrierenk2_0db) {
            ...
            QString beschr(tr("<b>Kalibrieren Kanal 2</b><br>"
                              ...
                              "   Das Dämpfungsglied sollte min. 20dB betragen.<br>"
                              "   <br><br>"
                              "Werte des Dämpfungsgliedes (dB):", "InputBox"));
...
void Nwt7linux::mkalibrierenk1() {
  ...
  QString beschr(tr("<b>Kalibrieren Kanal 1</b><br>"
                    ...
                    "   Beim NWT01 beträgt der Ausgangspegel bei 1MHz +4,25dBm.<br>"
                    "   Dieser Wert wird als Default unten eingeblendet.<br>"
                    "<br>"
                    "2. Im Ablauf der Kalibrieren wird ein genau bekanntes Dämpfungsglied<br>"
                    "   eingeschleift. Das Dämpfungsglied sollte min. 20dB betragen.<br>"
...
void Nwt7linux::mkalibrierenk2() {
  ...
  QString beschr(tr("<b>Kalibrieren Kanal 2</b><br>"
                    ...
                    "   Dieser Wert wird als Default unten eingeblendet.<br>"
                    "<br>"
                    "2. Im Ablauf der Kalibrierung wird ein genau bekanntes Dämpfungsglied<br>"
                    "   eingeschleift. Das Dämpfungsglied sollte min. 20dB betragen.<br>"
                    "   Aus diesen beiden Messergebnissen werden die Funktionskonstanden <br>"
                    "   errechnet die anschliessend in der Messsondendatei abgespeichert <br>"
                    "   werden muessen.<br>"
...
void Nwt7linux::vfoedit() {
  ...
  if (l > 10.0 && l < 9999999999.0) {
    //Drehgeber auslesen
    s1 = QString::asprintf("%4.6f", l / 1000000.0);
    //auf Display darstellen
    switch (lcdauswahl) {
      case 1:LCD1->display(s1);
        lcdfrq1 = l;
        break;
      case 2:LCD2->display(s1);
        lcdfrq2 = l;
        break;
      case 3:LCD3->display(s1);
        lcdfrq3 = l;
        break;
      case 4:LCD4->display(s1);
        lcdfrq4 = l;
        break;
      case 5:LCD5->display(s1);
        lcdfrq5 = l;
        break;
    }
    setdrehgebervonlcd();
...
void Nwt7linux::LCDaendern() {
  ...
  s = QString::asprintf("%4.6f", l / 1000000.0);
  //auf Display darstellen
  switch (lcdauswahl) {
    case 1:LCD1->display(s);
      lcdfrq1 = l;
      break;
    case 2:LCD2->display(s);
      lcdfrq2 = l;
      break;
    case 3:LCD3->display(s);
      lcdfrq3 = l;
      break;
    case 4:LCD4->display(s);
      lcdfrq4 = l;
      break;
    case 5:LCD5->display(s);
      lcdfrq5 = l;
      break;
  }
  s = QString::asprintf("%3.0f", l);
  editvfo->setText(s);
}
...
void Nwt7linux::editProfile() {
  ...
  r = dlg->exec();
  if (r == QDialog::Accepted) {
    // alle Profile ausser default löschen
...
void Nwt7linux::option() {
  ...
  if (r == QDialog::Accepted) {
    ...
    setDaempfungItem(); //Dämpfungsglied einstellen
    messtimer->stop();
    if (wgrunddaten.kalibrierende > long(wgrunddaten.maxwobbel)) {
      QMessageBox::warning(this, tr("Frequenzgrenzen", "InformationsBox"),
                           tr("<center><b>Die Endfrequenz der Kalibrierkorrektur ist"
                              " größer als die max. Wobbelfrequenz!</b></center><br>"
                              "<center>Die Endfrequenz der Kalibrierkorrektur wird angepasst.</center>",
                              "InformationsBox"));
...
void Nwt7linux::setAText(QString stty) {
  QString qs;
  if (fwversion > 0) {
    qs = QString::asprintf("FW:%01i.%02i:V%02i", fwversion / 100, fwversion - 100, fwvariante);
  } else {
    qs = "FW:0.00";
  }
...
void Nwt7linux::version() {
  ...
  if (bttyOpen) {
    ...
    qs = tr("<B>Abfrage der Firmware im PIC</B><BR>"
            "Das Ergebnis muss größer 100 sein.<BR><BR>"
            "Version: ");
    QString as;
    as = QString::asprintf("%03i", a);
...
void Nwt7linux::firmupdate() {
  ...
  QString beschr(tr("<b>Ablauf des Firmwareupdate</b><br>"
                    ...
                    "3. Laden der HEX-Datei für den PIC<BR><BR>"
                    "   <B>Weitere Infos folgen!!!</B>", "InformationsBox"));
  ...
  if (!s.isNull()) {
    ...
    if (f.open(QFile::ReadOnly)) {
      ...
      while (qs.indexOf("OK") == -1) {
        ...
        qDebug() << zeile;
#endif
        picmodem->writeLine(zeile.toStdString().c_str());
        c = ' ';
        while (picmodem->readttybuffer(&c, 1) != 1);
        i++;
        qs1 = QString::asprintf("Line: %i", i);
        firmw.setText(qs1);
        if (c == 'O') {
          qs = qs + c;
          while (picmodem->readttybuffer(&c, 1) != 1);
...
void Nwt7linux::setwattoffset1(int index) {
  //  qDebug("%i",index);
  switch (index) {
    case 0:woffset1 = wattoffsetk1[0].offsetwatt;
      break;
    case 1:woffset1 = wattoffsetk1[1].offsetwatt;
      break;
    case 2:woffset1 = wattoffsetk1[2].offsetwatt;
      break;
    case 3:woffset1 = wattoffsetk1[3].offsetwatt;
      break;
    case 4:woffset1 = wattoffsetk1[4].offsetwatt;
      break;
    case 5:woffset1 = wattoffsetk1[5].offsetwatt;
      break;
    case 6:woffset1 = wattoffsetk1[6].offsetwatt;
      break;
    case 7:woffset1 = wattoffsetk1[7].offsetwatt;
      break;
    case 8:woffset1 = wattoffsetk1[8].offsetwatt;
      break;
    case 9:woffset1 = wattoffsetk1[9].offsetwatt;
      break;
    case 10:woffset1 = wattoffsetk1[10].offsetwatt;
      break;
    case 11:woffset1 = wattoffsetk1[11].offsetwatt;
      break;
    case 12:woffset1 = wattoffsetk1[12].offsetwatt;
      break;
    case 13:woffset1 = wattoffsetk1[13].offsetwatt;
      break;
    case 14:woffset1 = wattoffsetk1[14].offsetwatt;
      break;
    case 15:woffset1 = wattoffsetk1[15].offsetwatt;
      break;
    case 16:woffset1 = wattoffsetk1[16].offsetwatt;
      break;
    case 17:woffset1 = wattoffsetk1[17].offsetwatt;
      break;
    case 18:woffset1 = wattoffsetk1[18].offsetwatt;
      break;
    case 19:woffset1 = wattoffsetk1[19].offsetwatt;
      break;
    case 20:woffset1 = wattoffsetk1[20].offsetwatt;
      break;
    case 21:woffset1 = wattoffsetk1[21].offsetwatt;
      break;
    case 22:woffset1 = wattoffsetk1[22].offsetwatt;
      break;
    case 23:woffset1 = wattoffsetk1[23].offsetwatt;
      break;
    case 24:woffset1 = wattoffsetk1[24].offsetwatt;
      break;
    case 25:woffset1 = wattoffsetk1[25].offsetwatt;
      break;
    case 26:woffset1 = wattoffsetk1[26].offsetwatt;
      break;
    case 27:woffset1 = wattoffsetk1[27].offsetwatt;
      break;
    case 28:woffset1 = wattoffsetk1[28].offsetwatt;
      break;
    case 29:woffset1 = wattoffsetk1[29].offsetwatt;
      break;
  }
}
...
void Nwt7linux::setwattoffset2(int index) {
  switch (index) {
    case 0:woffset2 = wattoffsetk2[0].offsetwatt;
      break;
    case 1:woffset2 = wattoffsetk2[1].offsetwatt;
      break;
    case 2:woffset2 = wattoffsetk2[2].offsetwatt;
      break;
    case 3:woffset2 = wattoffsetk2[3].offsetwatt;
      break;
    case 4:woffset2 = wattoffsetk2[4].offsetwatt;
      break;
    case 5:woffset2 = wattoffsetk2[5].offsetwatt;
      break;
    case 6:woffset2 = wattoffsetk2[6].offsetwatt;
      break;
    case 7:woffset2 = wattoffsetk2[7].offsetwatt;
      break;
    case 8:woffset2 = wattoffsetk2[8].offsetwatt;
      break;
    case 9:woffset2 = wattoffsetk2[9].offsetwatt;
      break;
    case 10:woffset2 = wattoffsetk2[10].offsetwatt;
      break;
    case 11:woffset2 = wattoffsetk2[11].offsetwatt;
      break;
    case 12:woffset2 = wattoffsetk2[12].offsetwatt;
      break;
    case 13:woffset2 = wattoffsetk2[13].offsetwatt;
      break;
    case 14:woffset2 = wattoffsetk2[14].offsetwatt;
      break;
    case 15:woffset2 = wattoffsetk2[15].offsetwatt;
      break;
    case 16:woffset2 = wattoffsetk2[16].offsetwatt;
      break;
    case 17:woffset2 = wattoffsetk2[17].offsetwatt;
      break;
    case 18:woffset2 = wattoffsetk2[18].offsetwatt;
      break;
    case 19:woffset2 = wattoffsetk2[19].offsetwatt;
      break;
    case 20:woffset2 = wattoffsetk2[20].offsetwatt;
      break;
    case 21:woffset2 = wattoffsetk2[21].offsetwatt;
      break;
    case 22:woffset2 = wattoffsetk2[22].offsetwatt;
      break;
    case 23:woffset2 = wattoffsetk2[23].offsetwatt;
      break;
    case 24:woffset2 = wattoffsetk2[24].offsetwatt;
      break;
    case 25:woffset2 = wattoffsetk2[25].offsetwatt;
      break;
    case 26:woffset2 = wattoffsetk2[26].offsetwatt;
      break;
    case 27:woffset2 = wattoffsetk2[27].offsetwatt;
      break;
    case 28:woffset2 = wattoffsetk2[28].offsetwatt;
      break;
    case 29:woffset2 = wattoffsetk2[29].offsetwatt;
      break;
  }
}
...
void Nwt7linux::tip(bool atip) {
  QString tip_kalibrierkorrk1 = tr(
      ...
      "Achtung das funktioniert nur mit der <b>log. Sonde!!!.</b><br>", "tooltip text");
  QString tip_grafik = Nwt7linux::tr(
      ...
      "<em><b>Space</b></em> der aktive Kursor wird die Mitte des Frequenzbereiches und setzt Frequenzanfang und Frequenzende neu. Anschliessend wird EINMAL WOBBELN ausgelöst<br>"
  ...
  QString tip_dial = Nwt7linux::tr(
      ...
      "VFO - 10 1 MHz 10 1 kHz 10 1 Hz<br>"
      "______A__S_____D__F_____G__H", "tooltip text");
  QString tip_checkmess = Nwt7linux::tr(
      "<b>Leistungsdämpfung</b><br>"
      "wird benutzt für<br>"
      ...
      "<br>"
      "Alle zusätzlichen Eintrage<br>"
      "können über das Menü wieder<br>"
      "gelöscht werden.<br>"
      "(Dämpfung auf default setzen)", "tooltip text");
  QString tip_mledit = Nwt7linux::tr(
      "<b>Infofenster</b><br>"
      "wird benutzt für Darstellung verschiedener<br>"
  ...
  QString tip_betriebsart = Nwt7linux::tr(
      ...
      "<u>SWV_ant</u> zusätzliches SWV direkt "
      "an der Antenne ermitteln<br>"
      "<u>Impedanz</u> Anzeige der Impedanz Z. "
      "Richtige Anzeige mit einem Serienwiderstand 50 Ohm <br>"
      "<u>Spektrumanalysator</u> Spektrumanalysator vom FA "
      "<u>Spek.FRQ-shift</u> SA. vom FA + Konverter", "tooltip text");
  QString tip_3db = Nwt7linux::tr(
      ...
      "Hintergrund ist die Bestimmung der Guete Q aus den 3 dB Werten. <br>", "tooltip text");
  QString tip_6db = Nwt7linux::tr(
      ...
      "wir noch der Shape-Faktor errechnet.", "tooltip text");
  QString tip_dbgrafik = Nwt7linux::tr(
      ...
      "grafische Darstellung automatisch mit aktiv.", "tooltip text");
  QString tip_schritte = Nwt7linux::tr(
      "<b>Schritte:</b><br>"
      "Die maximale Anzahl der Messpunkte beträgt 9999. Um auf eine <br>"
      ...
      "200 Schritte.", "tooltip text");
  QString tip_pbar = Nwt7linux::tr(
      "<b>Datenrücklauf</b><br>"
      "Anzeige der Daten, die beim Wobbeln von <br>"
      "der Baugruppe zurueck in den PC fliessen.", "tooltip text");
  QString tip_messtext = Nwt7linux::tr(
      "<b>Textfenster für Messwertspeicherung</b><br>"
      "Das Textfenster ist voll editierbar und <br>"
      "kann als Textdatei abgespeichert werden", "tooltip text");
  QString tip_messoffset = Nwt7linux::tr(
      ...
      "Es können 10 verschiedene Korrekturen eingegeben werden.<br>"
      "Dazu ist der Menuepunkt <em>Editieren Sonde</em> vorgesehen.<br>", "tooltip text");
  QString tip_swra_100 = Nwt7linux::tr(
      "<b>Eingabe der Kabeldämpfung</b><br>"
      "Die Dämpfung wird in dB/100m eingegeben nur die Zahl", "tooltip text");
  QString tip_swrlaenge = Nwt7linux::tr(
      "<b>Eingabe der Kabellänge</b><br>"
      "Die Kabellänge wird in Meter eingegeben nur die Zahl", "tooltip text");
  QString tip_lupeplus = Nwt7linux::tr(
      ...
      "gleichzeitig den ungefähren Mittelpunkt des <br"
      "Wobbelfensters. Der Frequenzbereich wird halbiert <br>"
      "und anschliessend <b>ein</b> Wobbeldurchlauf gestartet. <br>"
      "Frequenzgrenzen bilden die Kalibrierfrequenzangaben in der Option.", "tooltip text");
  ...
  QString tip_offset = Nwt7linux::tr(
      ...
      "Y-Beschriftung ändert ihre Farbe in Rot.", "tooltip text");
  QString tip_kursor = Nwt7linux::tr(
      "<b>Einstellung der Kursornummer</B><BR>"
      "Mit dem Mausrad oder durch Auswahl kann die <br>"
      "Nummer des Kursors geändert werden. Bereich 1-5.<br>"
      "Es ist immer nur die eingestellte Nummer aktiv", "tooltip text");
  ...
  QString tip_vfo_x4 = Nwt7linux::tr(
      ...
      "Damit ist es möglich SDR-Radio Softrock anzusteuern<br>"
      "Die Anzeige der Maximalfrequenz reduziert sich<br>"
      "entsprechend.<br>", "tooltip text");
  ...
  QString tip_displayshift = Nwt7linux::tr(
      ...
      "Senderausgang gemessen so muss ein Dämpfungsglied vor dem <br>"
      ...
      "In diesem Beispiel ist jetzt der Bereich bis +50dB sichtbar.<br>", "tooltip text");
  QString tip_scantime = Nwt7linux::tr(
      ...
      "nutzbar mit der passenden FW. <br>", "tooltip text");
  QString tip_profil = Nwt7linux::tr(
      "<b>Profil</B><BR>"
      "Mit der Combobox können Voreinstellungen für Frequenzanfang, <br>"
      "Frequenzende und Schrittanzahl ausgewählt werden. Zum Bearbeiten <br>"
      "der Profile gibt es einen Menuepunkt. <br>", "tooltip text");
  QString tip_invers = Nwt7linux::tr(
      ...
      "man um zum Beispiel aus einem Serienschwingkreis das Q zu ermitteln. <br>", "tooltip text");
  QString tip_sastatus = Nwt7linux::tr(
      ...
      "2. Funktion: Mit der richtigen FW kann die Rückmeldung <br>"
      "   vom SA aktiviert werden (in OPTION). Ich sehe die SA-Einstellungen <br>"
      "   in der SW. Die Rückmeldung erfolgt durch Spannungswerte <br>"
      "   die beim Umschalten im SA entstehen. <br>", "tooltip text");
  QString tip_bfrq = Nwt7linux::tr(
      "<b>Frequenzeingabe/Übernahme</B><BR>"
      "Die Frequenz kann ueber das Kursormenue gesetzt <br>"
      "werden oder auch direkt eingegeben werden. <br>"
      "Einheit ist MHz. <br>", "tooltip text");
  QString tip_bl = Nwt7linux::tr(
      "<b>Eingabe Induktivität</B><BR>"
      "Hier wird die Induktivität in uH eingegeben. <br>"
      "Daraus errechnet sich die Kapazität in pF. <br>", "tooltip text");
  QString tip_bc = Nwt7linux::tr(
      "<b>Eingabe Kapazität</B><BR>"
      "Hier wird die Kapazität in pF eingegeben. <br>"
      "Daraus errechnet sich die Induktivität in uH. <br>", "tooltip text");
  QString tip_bn = Nwt7linux::tr(
      "<b>Eingabe Windungen</B><BR>"
      "Hier werden die Windungen der Testinduktivität eingegeben. <br>"
      "Daraus errechnet sich der AL-Wert in nH/Windungen ins Quadrat. <br>", "tooltip text");
  QString tip_mhang = Nwt7linux::tr(
      "<b>Hängefunktion ein/aus</B><BR>"
      "Im Wattmeter ist eine Hängefunktion inplementiert. Nur höhere Werte <br>"
      "werden sofort angezeigt. Fällt der Wert wieder werden 8 Messungen kontrolliert. <br>"
      "Ist der Wert nach 8 Messungen immer niedriger als der angezeigte Wert, wird <br>"
      "der neue Wert zur Anzeige gebracht. <br>", "tooltip text");
  QString tip_alw = Nwt7linux::tr(
      "<b>Berechnung der Windungen aus dem AL-Wert</B><BR>"
      "Der AL-Wert wird entweder automatisch gefüllt durch die AL-Berechnung oder kann <br>"
      "auch per Hand eingegeben werden. Die Induktivität wird nur per Hand eingegeben.<br>", "tooltip text");
  QString tip_ymax = Nwt7linux::tr(
      "<b>Skalierung der Y-Achse (Ymax oberster Wert in dB)</B><BR>"
      "In dieser Combobox wird der oberste Wert der Y-Achse eingestellt. <br>", "tooltip text");
  QString tip_ymin = Nwt7linux::tr(
      "<b>Skalierung der Y-Achse (Ymin unterster Wert in dB)</B><BR>"
      "In dieser Combobox wird der unterste Wert der Y-Achse eingestellt. <br>", "tooltip text");
...
void Nwt7linux::keyPressEvent(QKeyEvent *event) {
  ...
  switch (event->key()) {
    case Qt::Key_Q:wert += 10000000.0;
      break;
    case Qt::Key_A:wert -= 10000000.0;
      break;
    case Qt::Key_W:wert += 1000000.0;
      break;
    case Qt::Key_S:wert -= 1000000.0;
      break;
    case Qt::Key_E:wert += 10000.0;
      break;
    case Qt::Key_D:wert -= 10000.0;
      break;
    case Qt::Key_R:wert += 1000.0;
      break;
    case Qt::Key_F:wert -= 1000.0;
      break;
    case Qt::Key_T:wert += 10.0;
      break;
    case Qt::Key_G:wert -= 10.0;
      break;
    case Qt::Key_Z:wert += 1.0;
      break;
    case Qt::Key_H:wert -= 1.0;
      break;
...
void Nwt7linux::fsendewobbeldaten() {
  //festlegen der Wobbelgrenzen, Bezug für die Hintergrundkurven
...
void Nwt7linux::setFrqFaktorLabel() {
  ...
  qs = QString::asprintf(" x %i", wobdaten.frqfaktor);
  qs = s + qs;
...
void Nwt7linux::zrausrechnen() {
  ...
  qs = QString::asprintf("%3.2f", r1);
  lr1->setText(qs);
  qs = QString::asprintf("%3.2f", r2);
  lr2->setText(qs);
  qs = QString::asprintf("%3.2f", r3);
  lr3->setText(qs);
  qs = QString::asprintf("%3.2f", r4);
  lr4->setText(qs);
  ...
  daempf = d1 + d2;
  qs = QString::asprintf("%3.2f", daempf);
...
void Nwt7linux::zlcausrechnen() {
  ...
  qs = QString::asprintf("%3.2f", l);
  ll->setText(qs);
  qs = QString::asprintf("%3.2f", c);
  lc->setText(qs);
}
    ...
    if (a != 4) {
      ...
      if (i2 < 1024) {
        if (dummycounter == 0) {
          ...
          qs = QString::asprintf("idx:%i, %0.2fV, %0.2f dBm", i2, 5.0 / 1024 * (double) i2, w);
        } else {
          dummycounter--;
          qs = "Warten!";
        }
...
void Nwt7linux::diagrammdim(int) {
  ...
  switch (idmin) {
    case 0:wobdaten.antdiagramm.dbmin = 10;
      break;
    case 1:wobdaten.antdiagramm.dbmin = 0;
      break;
    case 2:wobdaten.antdiagramm.dbmin = -10;
      break;
    case 3:wobdaten.antdiagramm.dbmin = -20;
      break;
    case 4:wobdaten.antdiagramm.dbmin = -30;
      break;
    case 5:wobdaten.antdiagramm.dbmin = -40;
      break;
    case 6:wobdaten.antdiagramm.dbmin = -50;
      break;
    case 7:wobdaten.antdiagramm.dbmin = -60;
      break;
    case 8:wobdaten.antdiagramm.dbmin = -70;
      break;
    case 9:wobdaten.antdiagramm.dbmin = -80;
      break;
  }
  switch (idmax) {
    case 0:wobdaten.antdiagramm.dbmax = 10;
      break;
    case 1:wobdaten.antdiagramm.dbmax = 0;
      break;
    case 2:wobdaten.antdiagramm.dbmax = -10;
      break;
    case 3:wobdaten.antdiagramm.dbmax = -20;
      break;
    case 4:wobdaten.antdiagramm.dbmax = -30;
      break;
    case 5:wobdaten.antdiagramm.dbmax = -40;
      break;
    case 6:wobdaten.antdiagramm.dbmax = -50;
      break;
    case 7:wobdaten.antdiagramm.dbmax = -60;
      break;
    case 8:wobdaten.antdiagramm.dbmax = -70;
      break;
    case 9:wobdaten.antdiagramm.dbmax = -80;
      break;
  }
